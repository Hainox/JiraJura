...
export const inspectionsApi = {
  ...
  list: (params?: { site_id?: string; status?: string; exclude_status?: string; district_id?: string; date_from?: string; date_to?: string; page?: number; page_size?: number; all_in_district?: boolean }) =>
